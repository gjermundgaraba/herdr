    ...
    let mut groups = vec![
        ...
        (
            ...
            vec![
                ...
                entry(binding_label(&keybinds.agent_picker), "agent list"),
                entry(binding_label(&keybinds.workspace_list), "workspace list"),
                entry(binding_label(&keybinds.history_back), "history back"),
                entry(binding_label(&keybinds.history_forward), "history forward"),
                entry(binding_label(&keybinds.mark_unread), "keep agent unread"),
